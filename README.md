...
## Example
Let's say you have messaages with subject lines
1. Topic 12345
2. Response to 12345
3. Msg 34568435
4. Msg 88734
...
If you use regex `(\s\d+)$` (match any string starting with  spacce and followed by any number of consecutive digits ending the subject line) then every msg will be tagged. Msgs 1, 2, and 5 will get SN1, msg 3 will get SN2, and msg 4 will get SN3.
